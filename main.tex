	...
	\begin{frame}{Signal processing pipeline for symbol decoding}
		\begin{figure}
			\begin{tikzpicture}[
				...
				\node (osc) [below=of mix] {$\cos(\omega_ct+\vartheta)$};
		...
		\begin{figure}
			\begin{tikzpicture}[
				...
				\node (osc) [below=of mix] {$\exp(i\omega_it)$};
			...
			\end{tikzpicture}
			\caption{Block diagram of the symbol-decoding including analog-to-digital conversion and pulse-shaping.}
		\end{figure}
	\end{frame}
