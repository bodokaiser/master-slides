...
\begin{document}
	...
	\begin{frame}{Dual-quadrature upconversion in time domain}
		\begin{figure}
			\begin{tikzpicture}[
					line width=0.2mm,
					node distance=5mm,
					...
					\node (osc) [right=of div] {$\sqrt{2}\cos(\omega_ct+\vartheta)$};
		...
		\begin{equation}
			...
			=
			x(t)
			\cos(\omega_0t+\vartheta)
			-
			p(t)
			\sin(\omega_0t+\vartheta)
			=
			\Re\left[
				\alpha(t)
	...
	\begin{frame}{Dual-quadrature upconversion in frequency domain}
		\begin{figure}
			\begin{tikzpicture}
				...
				\draw[very thick] (3,1) -- ++(0,-1.15) node[below] {$+\omega_0$};
				\draw[very thick] (-3,1) -- ++(0,-1.15) node[below] {$-\omega_0$};
				\draw[very thick, dashed] (-3.5,0) -- ++(0,0.5) -- ++(0.5,0) -- ++(0.5,0.25) -- ++(0,-0.75);
	...
	\begin{frame}{Software-defined receiver architecture}
		\begin{figure}
			...
			\end{tikzpicture}
			\caption{Block diagram of software-defined receiver architecture including electro-optical demodulation, analog-to-digital converter, and digital signal processing for symbol decoding.}
		\end{figure}
		\begin{figure}
			\begin{tikzpicture}[
				node distance=4mm,
			...
			\end{tikzpicture}
			\caption{Block diagram of the single-quadrature downconversion.}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{Single-quadrature heterodyning}
		\begin{figure}
			\begin{tikzpicture}
				\draw[very thick, -Latex] (0,0) -- ++(0,2.5) node[above] {$\abs{x(\omega)}^2$};
	...
	\begin{frame}{Single-quadrature homodyning}
		\begin{figure}
			\begin{tikzpicture}
				\draw[very thick, -Latex] (0,0) -- ++(0,2.5) node[above] {$\abs{x(\omega)}^2$};
				\draw[very thick, {-Bar[slant=.5]}] (0,0) -- (3.45,0);
